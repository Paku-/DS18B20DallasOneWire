...
// Very important, consult you LCD chip docs !!!
// Tested for optimum speed on Atmega328p at 16MHz
//******************************************
#define ENABLE_TIME 	1		//[us]
#define CHAR_DATA_TIME 	40		//[us]
#define COMMAND_TIME 	120		//[us]
...
#define LCD_ENABLE			3	//define MCU pin connected to LCD E
...
#define LCD_DATAPORT PORTD		//define MCU port connected to LCD data pins
#define LCD_CONTROLPORT PORTC	//define MCU port connected to LCD control pins
#define LCD_DDR DDRD			//define MCU direction register for port connected to LCD data pins
#define LCD_CDR DDRC			//define MCU direction register for port connected to LCD control pins

#define LCD_CLR             	0	//DB0: clear display
#define LCD_HOME            	1	//DB1: return to home position
#define LCD_ENTRY_MODE      	2	//DB2: set entry mode
#define LCD_ENTRY_MODE_INC		1	//DB1: increment
#define LCD_ENTRY_MODE_SHIFT 	0	//DB2: shift
#define LCD_DISPLAY		     	3	//DB3: turn lcd/cursor on
#define LCD_DISPLAY_ON      	2	//DB2: turn display on
#define LCD_CURSOR_ON       	1	//DB1: turn cursor on
#define LCD_BLINK_ON        	0	//DB0: blinking cursor
...
void LCDexecute();				//create the ENABLED pin pulse to call for command execution
